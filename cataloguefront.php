			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="cataloguefront.php">Catalogue</a></li>
...
<select name="type" style="width: 300px; height: 40px;font-size: 20px;  border-radius: 50px;background:rgba(230, 230, 230, 0.3);">
 <option  value="Tous Les Types">Afficher tous les produits</option> 
 <option value="Accessoires Informatique">Accessoires Informatique</option>
 <option   value="Accessoire de securite">Accessoire de securite </option> 
</select> 
<br><br>
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="cataloguefront.php">Catalogue</a></li>
								</ul>
							</div>
						</div>
